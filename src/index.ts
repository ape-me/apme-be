...
app.get("/", (c) =>
  c.json({
    ...
    reads: [
      ...
      "/v1/floor?stock=&limit=30&<filters>",
      "/v1/tokens?column=new|graduating|graduated&stock=&sort=&limit&cursor&<filters>",
      "/v1/stocks",
      "/v1/stocks/:mint/tokens?sort=volume|new|mcap&limit&cursor",
      "/v1/tokens/:mint",
      "/v1/tokens/:mint/candles?tf=1m|5m|15m|1h|4h|1d&limit&before",
      "/v1/tokens/:mint/trades?limit&before",
    ],
