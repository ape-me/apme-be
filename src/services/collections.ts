...
export const COLLECTIONS: readonly {
  ...
  },
  {
    ...
    symbols: ["APPLX", "MSFTX", "NVDAX", "AMZNX", "GOOGLX", "METAX", "TSLAX"],
  },
  {
    id: "crypto-stocks",
    title: "Crypto stocks",
    tagline: "Public companies that live on crypto",
    symbols: ["COINX", "CRCLX", "HOODX", "MSTRX", "STRCX", "WULF", "DFDV", "VIDAX"],
  },
  {
    id: "memestocks",
    title: "Meme stocks",
    tagline: "The originals",
    symbols: ["GMEX", "AMC", "DJT", "BB", "RUM", "WEBULL", "RBLX", "SNAP"],
  },
  {
    id: "prediction",
    title: "Bets & markets",
    tagline: "Prediction markets, sportsbooks, casinos",
    symbols: ["KALSHI", "POLYMARKET", "DKNG", "MGM"],
  },
  {
    id: "defense",
    title: "Defense & space",
    tagline: "Hardware for hard times",
    symbols: ["ANDURIL", "LMT", "BOEING"],
  },
  {
    id: "health",
    title: "Health",
    tagline: "Pharma and care",
    symbols: ["LLY", "JNJ", "PFIZER", "MRNA", "HIMS"],
  },
