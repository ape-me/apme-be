...
export const TokenFilters = z.object({
  ...
  minVol1h: z.coerce.number().min(0).optional(),
  minVol24h: z.coerce.number().min(0).optional(),
  minAge: z.coerce.number().min(0).optional(),
  maxAge: z.coerce.number().min(0).optional(), // minutes
  minProgress: z.coerce.number().min(0).max(100).optional(),
  maxProgress: z.coerce.number().min(0).max(100).optional(),
  minTxns1h: z.coerce.number().int().min(0).optional(),
  minBuys24h: z.coerce.number().int().min(0).optional(),
  maxTax: z.coerce.number().int().min(0).optional(), // bps
  minHolders: z.coerce.number().int().min(0).optional(),
  maxTop10: z.coerce.number().min(0).max(100).optional(),
  maxDev: z.coerce.number().min(0).max(100).optional(),
  maxSnipers: z.coerce.number().min(0).max(100).optional(),
  launchpad: z
    .string()
    .regex(/^[a-z,]+$/)
    .optional(), // csv of Launchpad
...
export const Stock = z.object({
  ...
  // its floor, last 24h
  heat: z.number(),
  launched24h: z.number().int(),
  memeVol24hUsd: z.number(),
  wallets24h: z.number().int(),
  king: King.nullable(),
...
export const Holding = z.object({
  mint: z.string(),
  kind: z.enum(["sol", "cash", "stock", "meme"]),
  symbol: z.string().nullable(),
...
export const TokenCard = z.object({
  ...
  mcapUsd: z.number().nullable(),
  vol24hUsd: z.number(),
  buys24h: z.number().int(),
  sells24h: z.number().int(),
  change24h: z.number().nullable(),
  taxBps: z.number().int(),
  progressPct: z.number().nullable(),
  lastTradeAt: z.number().int().nullable(),
  vol5mUsd: z.number(),
  buys5m: z.number().int(),
  sells5m: z.number().int(),
  vol1hUsd: z.number(),
  buys1h: z.number().int(),
  sells1h: z.number().int(),
  change1h: z.number().nullable(),
  athMcapUsd: z.number().nullable(),
  holders: z.number().int().nullable(),
  top10Pct: z.number().nullable(),
  devPct: z.number().nullable(),
  snipersPct: z.number().nullable(),
  website: z.string().nullable(),
  twitter: z.string().nullable(),
  telegram: z.string().nullable(),
  dexPaid: z.boolean(),
  dexPaidAt: z.number().int().nullable(),
  dexBoosts: z.number().int(),
});
...
export const FloorResponse = z.object({
  ...
  new: z.array(TokenCard),
  graduating: z.array(TokenCard),
  graduated: z.array(TokenCard),
  asOf: z.number().int(),
});
